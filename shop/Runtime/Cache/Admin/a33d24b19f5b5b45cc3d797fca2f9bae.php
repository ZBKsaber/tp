...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo DIST_URL;?>css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo BOWER_URL;?>font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-align-justify"></i> 产品中心<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/shop/index.php/Admin/Goods/showlist">产品展示</a>
                                </li>
                                <li>
                                    <a href="/shop/index.php/Admin/Goods/tianjia">添加商品</a>
                                </li>
                                <li>
    ...
    <script src="<?php echo DIST_URL;?>js/sb-admin-2.js"></script>
