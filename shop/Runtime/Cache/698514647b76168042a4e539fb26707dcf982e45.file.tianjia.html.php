<?php /* Smarty version Smarty-3.1.6, created on 2016-12-12 09:43:55
         compiled from "D:/wamp64/www/tp/shop/Admin/View\Auth\tianjia.html" */ ?>
<?php /*%%SmartyHeaderCode:28625584a674126de52-63398697%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '28625584a674126de52-63398697',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_584a67415b1d5',
  'variables' => 
  array (
    'auth_infoA' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_584a67415b1d5')) {function content_584a67415b1d5($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
...
" method="post" enctype="multipart/form-data">
                                   <div class="form-group">
                                       <label>权限名称</label>
                                       <input class="form-control" name="auth_name">
                                   </div>
                                   <div class="form-group">
                                       <label>父级权限</label>
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['auth_name'];?>
                                   ...
                                   <div class="form-group">
                                       <label>控制器</label>
                                       <input class="form-control" name="auth_c">
                                   </div>
                                   <div class="form-group">
                                       <label>操作方法</label>
                                       <input class="form-control" name="auth_a">
                                   </div>
