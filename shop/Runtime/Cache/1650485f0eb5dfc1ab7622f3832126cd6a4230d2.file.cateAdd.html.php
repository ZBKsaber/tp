<?php /* Smarty version Smarty-3.1.6, created on 2017-03-09 16:33:29
         compiled from "D:/wamp64/www/tp/shop/Admin/View\Goods\cateAdd.html" */ ?>
<?php /*%%SmartyHeaderCode:1583158c110b9a676a4-62347519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1650485f0eb5dfc1ab7622f3832126cd6a4230d2' => 
    array (
      0 => 'D:/wamp64/www/tp/shop/Admin/View\\Goods\\cateAdd.html',
      1 => 1489048408,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1583158c110b9a676a4-62347519',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58c110b9d5d45',
  'variables' => 
  array (
    'v' => 0,
    'vv' => 0,
...
<?php if ($_valid && !is_callable('content_58c110b9d5d45')) {function content_58c110b9d5d45($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
">
                                   <div class="form-group">
                                       <label>分类名称</label>
                                       <input class="form-control" name="cat_name" value="<?php echo $_smarty_tpl->tpl_vars['post']->value['cat_name'];?>
">
                                       <span class="text-danger"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['cat_name'];?>
</span>
                                   </div>
                                   <div class="form-group">
                                       <label>所属分类</label>
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['cat_name'];?>
                                        ...
                                        <span class="text-danger"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['pid'];?>
</span>
                                   </div>
                                   <div class="form-group">
                                       <label>是否在导航显示</label>
                                       ...
                                       <input type="radio" name="status" value="0"> 不显示
                                        <span class="text-danger"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['status'];?>
</span>
                                   </div>
